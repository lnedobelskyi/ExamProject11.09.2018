...
public class GoogleSearchResultSecondPage extends BasePage{
    ...
    public GoogleSearchResultSecondPage(WebDriver browser) {
    ...
    public List<String> getSearchResultsList() {
        List<java.lang.String> searchResultsList = new ArrayList<String>();
